...
public class ExampleSubsystem extends SubsystemBase {
	...
	///////////////// Methods to be called from other files
...
### Motor Control
This is a (hopefully) comprehensive guide on how to control motors in FRC. This guide assumes you are using TalonFX or TalonSRX motor variables.

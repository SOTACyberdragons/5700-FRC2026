...
public class ShootSetpointCommand extends Command {
	...
	public ShootSetpointCommand(ShooterSubsystem shooter, ShooterSetpoint setpoint) {
	...
	public void execute() {
		...
		m_shooterSubsystem.runShooter(shooterSetpoint.leaderMotorTargetPercentOutput);
	}
